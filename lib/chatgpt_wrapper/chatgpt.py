...
class ChatGPT:
    ...
    def __init__(self, pw = None, headless: bool = True, browser="firefox", timeout=60):
        self.pw = pw                    
        ## pw is a browser instance variable from outside
        if self.pw == None:
    ...
    def ask_stream(self, prompt: str, token=''):
        ...
        while True:
            ...
            if full_event_message is not None:
                ...
                # sio.emit('response', {'result': chunk}, room=sid)
                yield chunk
                # yield full_event_message
    ...
    def ask(self, message: str,token = '') -> str:
        """
