...
import { Modal, Layout, Menu, Input, Card, Button,Space,ConfigProvider,theme} from 'antd';
  ...
  <Sider style={{fontWeight: 700, marginRight: '20px', marginBottom: '20px'}}>
    ...
    <label>
          ...
          <Input type="number" value={history}
            onChange={e => {setHistory(e.target.value); fetchMsgs()}} min={1} max={10}/>
    </label>
  </Sider>
    ...
    <form onSubmit={handleSubmit}>
      <Space direction="vertical" size="small" style={{ display: 'flex' }}>
        ...
        <Card >
          ...
          <Button disabled={butt} type="primary" htmlType="submit" onClick={handleSubmit}>Send</Button>
        </Card> 
        </div> 
      </Space> 
    </form>
