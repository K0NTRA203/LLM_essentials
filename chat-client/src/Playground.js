...
<Sider theme='light' style={{backgroundColor: '#e8dcec', marginRight: '20px', marginBottom: '20px'}}>
...
<Content style={{backgroundColor: '#d4d4d4'}}>
  <form onSubmit={handleSubmit}>
    <Space direction="vertical" size="large" style={{ display: 'flex' }}>
      <Card ref={cardRef} title={name} value={result} style={{ height: '90%', overflow: 'auto' }}> {cards} </Card> 
        <div> 
        ...
        <Sider style={{backgroundColor: '#e8dcec', marginLeft: '20px'}}>
        <form onSubmit={handleSubmit}>
          <label>
            Engine:
